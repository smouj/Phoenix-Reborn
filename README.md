...
Specialized skill for **reliability** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Phoenix Reborn helps execute reliability tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **reliability** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for reliability scenarios.
...
**Input:** "Audit and improve reliability workflow."
